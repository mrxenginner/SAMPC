...
{	
	...
	pNetGame->m_bShowNameTags = (params[1] != 0);
	return 1;
}
...
static cell n_AllowInteriorWeapons(AMX *amx, cell *params)
{
	...
	pNetGame->m_bAllowWeapons = (params[1] != 0);
	return 1;
}
...
static cell n_AddSimpleModel(AMX* amx, cell* params)
{
	char* szDffName;
	char* szTxdName;

	CHECK_PARAMS(amx, "AddSimpleModel", 5);
	...
	if (pArtwork)
	{
		...
		return pArtwork->AddModelEntry(2, iVirtualWorld, iBaseID,
			iNewID, szDffName, szTxdName, false, false);
	}
	return 0;
}
...
AMX_NATIVE_INFO custom_Natives[] =
{
	...
	DEFINE_NATIVE(TextDrawSetSelectable),
	DEFINE_NATIVE(TextDrawGetSelectable),
	...
	DEFINE_NATIVE(PlayerTextDrawGetSelectable),
	...
	DEFINE_NATIVE(SelectTextDraw),
	DEFINE_NATIVE(CancelSelectTextDraw),

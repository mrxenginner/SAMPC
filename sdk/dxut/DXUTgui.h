...
protected:
    ...
    struct CInputLocale
    {
        ...
        TCHAR m_wszLangAbb[3];  // Language abbreviation
        TCHAR m_wszLang[64];    // Localized language name
    };
    ...
    static PCHAR  s_wszCurrIndicator;    // Points to an indicator string that corresponds to current input locale
    static TCHAR   s_aszIndicator[5][3];  // String to draw to indicate current input locale
    ...
    static DWORD   s_dwLastEventTick;
